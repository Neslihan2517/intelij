...
public class C01_MethodCreation {
    ...
    !! methodlar tekrarlanan işleri tek seferde yapmamızı sağlar.
    !!! hataları görmeyi ve düzeltmeyi kolaylaştırır.
    !!!! method--- yapılacak işler için bir kalıp oluşturmamızı sağlar.
    !!!!! "call etmek" -----> çağırmak/çalıştırmak. methodun aksiyonlarını main method ile ilişkilendirmemiz gerekir.
    !!!!!! method yazarken parametre emir kipinde yazılır./Örn:topla
...
//public static void topla(){} -----> parametresiz method
